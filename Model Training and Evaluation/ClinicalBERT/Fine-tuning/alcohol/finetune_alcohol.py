...
def tokenize_texts(dataset):
    ...
    def tokenize_function(examples):
        return tokenizer(examples["translated"], padding="max_length", max_length = 393, truncation=True)
...
if __name__ == "__main__":
    ...
    model = AutoModelForSequenceClassification.from_pretrained("medicalai/ClinicalBERT", num_labels=4)
    training_args = TrainingArguments(output_dir='finetuned_ClinicalBERT_alcohol', evaluation_strategy="epoch", num_train_epochs = 10, save_strategy="no")
    ...
    trainer.train()
    trainer.push_to_hub("Hielke/finetuned_ClinicalBERT_alcohol")