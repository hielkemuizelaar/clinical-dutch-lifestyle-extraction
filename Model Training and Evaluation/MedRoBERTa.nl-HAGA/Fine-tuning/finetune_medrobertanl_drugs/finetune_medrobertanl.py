...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(output_dir="finetuned_MedRoBERTa.nl_drugs", evaluation_strategy="epoch", save_strategy="no", num_train_epochs = 10)
    ...
    trainer.train()
    trainer.push_to_hub("Hielke/finetuned_MedRoBERTa.nl_drugs")