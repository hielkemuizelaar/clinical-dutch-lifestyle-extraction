...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(output_dir='finetuned_RobBERT', evaluation_strategy="epoch", num_train_epochs = 50, save_strategy="no")
    ...
    trainer.train()
    trainer.push_to_hub("Hielke/RobBERT-HAGA-finetuned")