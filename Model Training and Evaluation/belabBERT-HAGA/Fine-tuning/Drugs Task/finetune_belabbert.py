...
if __name__ == "__main__":
    ...
    model = AutoModelForSequenceClassification.from_pretrained("Hielke/belabBERT-HAGA", num_labels=4)
    training_args = TrainingArguments(output_dir='finetuned_belabBERT_drugs', evaluation_strategy="epoch", save_strategy="no", num_train_epochs = 10)
    ...
    trainer.train()
    trainer.push_to_hub("Hielke/finetuned_belabBERT_drugs")