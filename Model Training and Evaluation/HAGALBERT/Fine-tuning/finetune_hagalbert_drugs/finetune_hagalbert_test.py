...
if __name__ == "__main__":
    ...
    model = AutoModelForSequenceClassification.from_pretrained("Hielke/HAGALBERT", num_labels=4)
    training_args = TrainingArguments(output_dir="HAGALBERT-finetuned_drugs", save_strategy="no", evaluation_strategy="epoch", num_train_epochs = 10)
    ...
    trainer.train()
    trainer.push_to_hub("thesis-hielke/HAGALBERT-finetuned_drugs")