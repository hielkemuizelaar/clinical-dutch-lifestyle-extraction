...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(output_dir="test_trainer", save_strategy="no", evaluation_strategy="epoch", num_train_epochs = 10)
    ...
    trainer.train()
    trainer.push_to_hub("thesis-hielke/HAGALBERT-finetuned_alcohol")