...
def tokenize_texts(dataset):
    ...
    def tokenize_function(examples):
        return tokenizer(examples["translated"], padding="max_length", truncation=True)
...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(output_dir='finetuned_BioBERT_smoking', evaluation_strategy="epoch", num_train_epochs = 10, save_strategy="no")
    ...
    trainer.train()
    trainer.push_to_hub("Hielke/finetuned_BioBERT_smoking")