...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(output_dir='finetuned_BioBERT_drugs', evaluation_strategy="epoch", num_train_epochs = 10, save_strategy="no")
    ...
    trainer.train()
    trainer.push_to_hub("Hielke/finetuned_BioBERT_drugs")